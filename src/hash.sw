...
use ::utils::{rf0, rf1, rf2, rf3, rf4, u32_to_u8s, u64_into_bytes, u8_4_to_u32, u8_64_into_bytes};
...
/* Parallel round 1 */
    ...
    let (a, c) = rf4(a, b, c, d, e, KK0, 6, 12, x);/* #15 *//* Parallel round 2 */
    ...
    let (e, b) = rf3(e, a, b, c, d, KK1, 11, 2, x); /* #31 */ /* Parallel round 3 */
    ...
    let (d, a) = rf2(d, e, a, b, c, KK2, 5, 13, x); /* #47 */ /* Parallel round 4 */
    ...
    let (c, e) = rf1(c, d, e, a, b, KK3, 8, 14, x); /* #63 */ /* Parallel round 5 */
